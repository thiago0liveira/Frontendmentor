              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <img
                    ...
                    src="https://www.frontendmentor.io/static/images/logo-mobile.svg?color=indigo&shade=500"
                    alt="Frontent Mentor Solved Challgenges"
                  />
                  <img
                  ...
                  <div>
                    <Menu.Button className="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <img
                        ...
                        src="https://avatars.githubusercontent.com/u/8736827?v=4"
                        alt=""
                      />
                    </Menu.Button>
                  </div>
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href="https://github.com/thiago0liveira"
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href="https://www.linkedin.com/in/th-oliveira-f/"
                            className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700')}
                          >
                            Linkedin
                          </a>
